...
Route::group(['prefix' => config('uspdev-forms.prefix'), 'middleware' => ['web']], function () {
    ...
    Route::get('definitions/{formDefinition}/backup-list/{created_time}/restore',[DefinitionController::class, 'restore_backup'])->name('form-definitions.backup-restore');
    Route::get('definitions/{formDefinition}/backup-list/{created_time}/remove',[DefinitionController::class, 'remove_backup'])->name('form-definitions.backup-remove');
